 ...
 *
 * ↓ YOUR CODE HERE ↓ */
const foodToEat = "hamburger and fries";
const drinkToDrink = "mountain dew";
let name = "David";
let friendsName = "Scott";
//Question: Name a reason why you would use const instead of let.
//Answer:the value of thr variable will always be the same
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`My name is ${name} and this is my friend ${friendsName}
We have ordered ${foodToEat} with ${drinkToDrink} to drink`)
...
Answer: console.log("My name is "+ name + " and this is my friend" + friendsName );
//"We have ordered " ${foodToEat} + " with " + ${drinkToDrink} " to drink. ");
console.log(`-------------------------- 
Question 2a: Oh no`)
 ...
 *
 * HOW DO YOU REASSIGN A CONST     Step 1: In the section below, reassign your drink item to something else. console.log() your drink variable and run your code.
 * Step 2: Make a change to your code in Question 1 to fix the error. Run your code to make sure it's fixed.
 *
 * ↓ YOUR CODE HERE ↓ */
//const drinkToDrink = "Root Beer"
//Question: Read the error message - in your own words - what does it mean?
//Answer: you can't redeclare a variable
...
const lunchTime = (foodChoice, drinkChoice) => {
   return `My name is ${name} and this is my friend ${friendsName}
   We have ordered ${foodChoice} with ${drinkChoice} to drink`;
}
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
foodForTodayAndTomorrow = (tomorrowsFoodChoice, tomorrowsDrinkChoice, callbackFunction) => {
